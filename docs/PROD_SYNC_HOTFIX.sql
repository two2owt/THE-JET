-- JET — production hotfix: align Live with the known-good preview schema.
-- Run in Cloud View > Run SQL with **Live** selected. Idempotent; safe to re-run.

-- =====================================================================
-- 1. SECURITY DEFINER functions: remove anonymous EXECUTE
-- =====================================================================
DO $$
DECLARE
  fn record;
...
-- =====================================================================
-- 2. Views must run with the querying user's permissions (inherit RLS)
-- =====================================================================
DO $$
DECLARE v record;
BEGIN
...
-- =====================================================================
-- 3. Realtime publication: drop sensitive tables
-- =====================================================================
DO $$
DECLARE t text;
BEGIN
...
-- =====================================================================
-- 5. Verification — expect: 0 / all "on" / no sensitive tables / 2 cols
-- =====================================================================
SELECT
