...
// The map container only exists after React hydrates, so the intersection
// watcher retries through a MutationObserver instead of looking exactly once.
const mapboxLoaderScript = `!function(){var m=!1,mo=null,o=null,l=function(){if(!m){m=!0;if(mo)mo.disconnect();if(o)o.disconnect();var c=document.createElement("link");c.rel="stylesheet";c.href="${MAPBOX_CDN_STYLESHEET}";c.crossOrigin="anonymous";document.head.appendChild(c);var s=document.createElement("script");s.src="${MAPBOX_CDN_SCRIPT}";s.async=!0;s.crossOrigin="anonymous";document.head.appendChild(s)}};var d=function(){typeof requestIdleCallback!=="undefined"?requestIdleCallback(l,{timeout:6e3}):setTimeout(l,5e3)};document.readyState==="complete"?d():window.addEventListener("load",function(){setTimeout(d,200)},{once:!0});if("IntersectionObserver"in window){o=new IntersectionObserver(function(e){e[0].isIntersecting&&l()},{rootMargin:"200px"});var b=function(){var e=document.querySelector("[data-map-container]");if(!e)return!1;o.observe(e);if(mo)mo.disconnect();return!0};if(!b()&&"MutationObserver"in window){mo=new MutationObserver(function(){b()});mo.observe(document.documentElement,{childList:!0,subtree:!0});setTimeout(function(){if(mo)mo.disconnect()},15e3)}}}();`;
