...
export default defineTool({
  ...
  inputSchema: {
    ...
    venue_address: z.string().trim().optional().describe("Street address of the venue."),
    venue_category: z.string().trim().optional().describe("Category such as food, drink, nightlife, or events."),
    deal_id: z.string().uuid().optional().describe("Optional deal id to associate with this favorite."),
  },
