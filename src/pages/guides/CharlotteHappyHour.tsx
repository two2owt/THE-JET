      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-8 pb-nav-safe">
        ...
        <article className="max-w-none">
          ...
          <p className="text-muted-foreground mb-8">
            A neighborhood guide to Charlotte happy hour — and how to see
            what&apos;s actually running right now.
          </p>

          <section className="mb-10">
            <p className="text-foreground/90 mb-4">
              Charlotte happy hour is one of the best value windows in the city:
              most bars and restaurants discount drinks and shareable plates on
              weekdays between <strong>4pm and 7pm</strong>, and a growing
              number of South End and NoDa spots add a late-night reverse happy
              hour after 9pm.
            </p>
            <p className="text-foreground/90">
              Printed lists go stale fast — venues change specials weekly. JET
              solves that by showing merchant-posted deals on a live map, so
              every special you see is one a venue confirmed is active today.
            </p>
          </section>

          <section className="mb-10">
            <h2 className="text-2xl font-bold mb-4">
              Charlotte happy hour by neighborhood
            </h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold mb-4">
              How to find live happy hour deals near you
            </h2>
            <ol className="list-decimal pl-6 space-y-3 text-foreground/90">
              <li>
                <strong>Open the live map.</strong> The JET heatmap shows where
                Charlotte is busy right now, so you can pick a block that&apos;s
                already buzzing.
              </li>
              <li>
                <strong>Tap a venue.</strong> Each card shows whether the venue
                is open, what deal is active, and when it expires.
              </li>
              <li>
                <strong>Save your favorites.</strong> Favorited venues push you
                an alert the moment they post a new happy hour special.
              </li>
            </ol>
          </section>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold mb-4">
              Happy hour tips that actually save money
            </h2>
            <ul className="list-disc pl-6 space-y-2 text-foreground/90">
              <li>
                Mondays and Tuesdays carry the deepest discounts — weekend
                specials are usually thinner.
              </li>
              <li>
                Bar seating is often required for happy hour pricing; patios
                sometimes aren&apos;t included.
              </li>
              <li>
                Reverse happy hours (9pm onward) beat early windows in South End
                and NoDa.
              </li>
              <li>
                Check the expiration on a deal before you drive — Charlotte
                specials frequently end at 6:30pm.
              </li>
            </ul>
          </section>
          ...
          <section className="rounded-2xl border border-border bg-card p-6 mb-10">
            <h2 className="text-2xl font-bold mb-2">
              See tonight&apos;s Charlotte deals live
            </h2>
            <p className="text-foreground/90 mb-4">
              Skip the outdated lists. Open the real-time map and see which
              Charlotte venues have a happy hour running right now.
            </p>
