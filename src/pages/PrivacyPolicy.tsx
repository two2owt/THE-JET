        ...
        <div className="prose prose-sm sm:prose lg:prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80 mb-4">
              <li><strong>Account Information:</strong> Email address, display name, profile picture, and optional bio. If you sign in with Google, we receive your email address, name, and profile image from Google.</li>
              <li><strong>Profile Data:</strong> Birthdate (used for age verification), gender, pronouns (optional)</li>
              <li><strong>Social Links:</strong> Instagram, Twitter, TikTok, LinkedIn, Facebook URLs (optional)</li>
              <li><strong>Preferences:</strong> Taste categories (food, drinks, nightlife, events), notification settings, location settings, and profile visibility settings</li>
              <li><strong>User Content:</strong> Saved favorites, direct messages and images you send to other users, and connection (crew) requests</li>
              <li><strong>Search Activity:</strong> Venue and deal searches you run in the app</li>
            </ul>

            <h3 className="text-xl font-semibold mb-3">2.2 Automatically Collected Information</h3>
            <ul className="list-disc pl-6 space-y-2 text-foreground/80 mb-4">
              <li><strong>Location Data:</strong> Precise GPS location (only when you grant permission) to show nearby deals and venues and to power the live activity map</li>
              <li><strong>Approximate Location:</strong> If you decline precise location, we may derive an approximate city-level location from your network/IP address so the map can open somewhere useful</li>
              <li><strong>Device and Browser Information:</strong> Device and browser type, operating system, and app/session identifiers</li>
              <li><strong>Usage Data:</strong> Screens viewed, features used, deals and venues tapped, search queries, and interaction timestamps</li>
              <li><strong>Push Subscriptions and Tokens:</strong> Web push subscription endpoints and native device tokens used to deliver notifications, plus delivery receipts (sent, delivered, opened)</li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              ...
              <li>User Content (favorites, messages, images, profile content)</li>
              <li>Identifiers (user ID, device/push identifiers)</li>
              <li>Usage Data (app interactions, search history)</li>
              <li>Purchases (subscription status; card details are handled by Stripe and never reach our servers)</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              ...
              <li><strong>Location-Based Services:</strong> Show deals on the map, and send proximity alerts when you enter an area around a venue with an active special (geofencing), if you enable them</li>
              <li><strong>Aggregated Activity Maps:</strong> Combine location points from many users into the heatmap and flow-path layers that show where activity is concentrated</li>
              <li><strong>Push Notifications:</strong> Alert you about updates to your favorite venues and deals, connection requests, new messages, and account or service notices</li>
              <li><strong>Social and Messaging:</strong> Let you find discoverable users, send and receive connection requests, and exchange direct messages and images</li>
              <li><strong>Subscriptions:</strong> Provision paid tiers and confirm entitlement through our payment processor</li>
              <li><strong>Analytics:</strong> Understand usage patterns to improve the app experience (first-party only; no advertising networks)</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80 mb-4">
              ...
              <li><strong>Precision:</strong> We collect precise location for accurate map display. Points are smoothed and rate-limited before storage, and coordinates are obfuscated (reduced in precision) after 7 days</li>
              <li><strong>Aggregation Safeguard:</strong> Heatmap cells and flow-path segments shown to other users are only rendered when enough distinct users contribute to them (a minimum of three), so individual movement is not exposed. Your own recent activity remains visible to you.</li>
              <li><strong>Retention:</strong> Precise location history is retained for up to 30 days to power live features. After 30 days, points are moved to a historical archive used for trend analysis and are no longer used for live display.</li>
              <li><strong>Opt-Out:</strong> You can disable location sharing at any time in your device settings or in the app&apos;s location settings. Turning it off stops new collection; existing points age out on the schedule above.</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              ...
              <li><strong>Other Users:</strong> Your display name, avatar, and bio may be visible to other users if you enable discoverability, and are visible to users you have connected with regardless of that setting. Messages and images you send are visible to their recipients.</li>
              <li><strong>Aggregated Data:</strong> De-identified, aggregated activity data (such as heatmap density) that does not identify you individually</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              ...
              <li><strong>Firebase Cloud Messaging (Google):</strong> Delivery of native push notifications (<a href="https://policies.google.com/privacy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Privacy Policy</a>)</li>
              <li><strong>Browser Push Services:</strong> Web push notifications are relayed by your browser vendor&apos;s push service (for example Google, Apple, or Mozilla)</li>
              <li><strong>Resend:</strong> Transactional and verification email delivery (<a href="https://resend.com/legal/privacy-policy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Privacy Policy</a>)</li>
              <li><strong>Google Sign-In:</strong> Optional authentication provider (<a href="https://policies.google.com/privacy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Privacy Policy</a>)</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              ...
              <li><strong>Precise Location History:</strong> Retained up to 30 days for live features, with coordinates obfuscated after 7 days</li>
              <li><strong>Archived Location Data:</strong> After 30 days, location points are moved to a historical archive used for aggregate trend analysis</li>
              <li><strong>Messages and Images:</strong> Retained until deleted by a participant or until the account is deleted</li>
              <li><strong>Notification Records:</strong> Delivery and read receipts retained to power your in-app Alerts inbox and to prevent duplicate sends</li>
              <li><strong>Search History:</strong> Retained for your account until you clear it or delete your account</li>
              <li><strong>Analytics and Security Logs:</strong> Retained for a limited period to improve the service, enforce rate limits, and investigate abuse</li>
            </ul>
          </section>
