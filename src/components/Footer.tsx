    ...
    >
      ...
      <div
        style={{
          ...
          height: "1px",
          background:
            "linear-gradient(90deg, hsl(var(--primary) / 0.2), hsl(var(--accent) / 0.3), hsl(var(--primary) / 0.2))",
        }}
      />
      ...
      >
        ...
        >
          {footerLinks.map((link) => {
            ...
            const className =
              "hover:text-foreground transition-colors duration-200 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-primary rounded-md px-2 py-1.5";
