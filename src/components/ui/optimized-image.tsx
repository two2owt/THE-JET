...
export const OptimizedImage = memo(
  ({
    ...
    const optimizedSrc = isSupabase
      ? getSupabaseImageUrl(src, 640, quality)
      : src;
    const srcSet =
      responsive && isSupabase
        ? generateSrcSet(src, responsiveSizes, quality)
        : undefined;
    const sizes =
      responsive && isSupabase
    ...
    const placeholderSrc = isSupabase ? getSupabaseImageUrl(src, 20, 20) : src;
