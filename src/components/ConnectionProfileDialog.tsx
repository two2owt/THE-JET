        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <LuxeAvatar
                src={filteredProfile.avatar_url}
                alt={filteredProfile.display_name || "User"}
                initials={filteredProfile.display_name?.charAt(0)}
                forceIconFallback={!filteredProfile.avatar_url}
