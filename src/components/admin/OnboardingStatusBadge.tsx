...
export function OnboardingStatusBadge({
  ...
  if (completedAt) {
    return (
      <Badge
        variant="default"
        className="gap-1 bg-emerald-600/15 text-emerald-300 border-emerald-600/40 hover:bg-emerald-600/20"
      >
  ...
  if (startedAt) {
    return (
      <Badge
        variant="secondary"
        className="gap-1 bg-amber-500/15 text-amber-300 border-amber-500/40"
      >
  ...
  return (
    <Badge
      variant="outline"
      className="gap-1 text-muted-foreground border-border/60"
    >
