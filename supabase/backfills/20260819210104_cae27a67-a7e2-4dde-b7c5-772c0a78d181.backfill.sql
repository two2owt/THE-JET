...
-- One-off admin backfill extracted from 20260819210104_cae27a67-a7e2-4dde-b7c5-772c0a78d181.sql.
-- Run it from the admin dashboard (or as service_role) instead of shipping
-- the DML inside a migration.

CREATE OR REPLACE FUNCTION public.admin_backfill_20260819210104_cae27a67_a7e2_4dde_b7c5_772c0a78d(_dry_run boolean DEFAULT true)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  IF _dry_run THEN
    RETURN jsonb_build_object(
      'dry_run', true,
      'source_migration', '20260819210104_cae27a67-a7e2-4dde-b7c5-772c0a78d181.sql',
      'statements', 1
    );
  END IF;

  -- from 20260819210104_cae27a67-a7e2-4dde-b7c5-772c0a78d181.sql:2
...
REVOKE EXECUTE ON FUNCTION public.admin_backfill_20260819210104_cae27a67_a7e2_4dde_b7c5_772c0a78d(boolean) FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.admin_backfill_20260819210104_cae27a67_a7e2_4dde_b7c5_772c0a78d(boolean) TO authenticated, service_role;
