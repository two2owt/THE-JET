...
const CHARLOTTE_TOP_VENUES = [
  {
    ...
    priceLevel: 3,
    phone: "(704) 445-2200",
    website: "https://www.merchantandtradeclt.com",
    description:
      "19th-floor rooftop lounge with skyline views, craft cocktails, and shareable small plates above Uptown.",
    openingHours: HOURS.rooftop,
  },
  {
    id: "punch-room",
    name: "The Punch Room",
    ...
    phone: "(704) 445-2664",
    website:
      "https://www.ritzcarlton.com/en/hotels/cltrz-the-ritz-carlton-charlotte/dining/the-punch-room",
    description:
      "Intimate Ritz-Carlton cocktail lounge built around a rotating menu of bespoke punches.",
  ...
  },
  {
    ...
    priceLevel: 3,
    phone: "(704) 595-7710",
    website: "https://www.heirloomrestaurantnc.com",
    description:
      "Farm-to-table New American sourcing exclusively from North Carolina growers and producers.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "supperland",
    name: "Supperland",
    ...
    priceLevel: 3,
    phone: "(704) 817-2877",
    website: "https://www.supperlandrestaurant.com",
    description:
      "Southern Sunday-supper cooking served inside a renovated 1950s church in Plaza Midwood.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "haberdish",
    ...
    priceLevel: 2,
    phone: "(704) 817-1084",
    website: "https://www.haberdish.com",
    description:
      "Modern Southern comfort food and a serious craft-cocktail program in the heart of NoDa.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "seoul-food",
    ...
    priceLevel: 2,
    phone: "(980) 938-2299",
    website: "https://www.seoulfoodmeatco.com",
    description:
      "Korean BBQ meets Southern smoke — bulgogi, bibimbap, and brisket in South End.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "crunkleton",
    ...
    priceLevel: 3,
    phone: "(980) 949-8255",
    website: "https://thecrunkleton.com/charlotte",
    description:
      "Members-friendly speakeasy with 400+ whiskeys and classic-craft cocktails in Elizabeth.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "fahrenheit",
    ...
    priceLevel: 4,
    phone: "(980) 327-6776",
    website: "https://www.fahrenheitcharlotte.com",
    description:
      "Chef Rocco Whalen's 21st-floor steakhouse with sweeping Uptown views and a wraparound patio.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "angelines",
    ...
    priceLevel: 3,
    phone: "(704) 445-2540",
    website: "https://www.angelinesclt.com",
    description:
      "Coastal-Italian dining inside The Ivey's Hotel — handmade pastas and an aperitivo-forward bar.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "wooden-robot",
    ...
    description:
      "Farmhouse-leaning South End brewery known for Good Morning Vietnam coffee blonde ale.",
    openingHours: HOURS.brewery,
  },
  {
    ...
    priceLevel: 3,
    phone: "(704) 372-1395",
    website: "https://www.duckworths.com/cellar",
    description:
      "Subterranean speakeasy beneath Duckworth's with rare spirits and dealer's-choice cocktails.",
    openingHours: HOURS.bar_late,
  },
  {
    ...
    priceLevel: 2,
    phone: "(704) 348-1848",
    website: "https://www.soulgastrolounge.com",
    description:
      "Plaza Midwood tapas and sushi mainstay with a vinyl-spinning DJ and rooftop patio.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "kindred-davidson",
    ...
    description:
      "James Beard semifinalist Joe Kindred's neighborhood restaurant — milk bread, pastas, and seasonal plates.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "leahandlouise",
    ...
    priceLevel: 2,
    phone: "(980) 939-0061",
    website: "https://www.leahandlouise.com",
    description:
      "Modern juke joint celebrating Black foodways of the Mississippi River Valley at Camp North End.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "optimist-hall",
    ...
    priceLevel: 2,
    phone: "(980) 207-0022",
    website: "https://optimisthall.com",
    description:
      "Adaptive-reuse food hall with 20+ vendors — dumplings, tacos, ramen, coffee, and craft beer.",
    openingHours: HOURS.food_hall,
  },
  {
    id: "noble-smoke",
    name: "Noble Smoke",
    ...
    priceLevel: 2,
    phone: "(704) 727-1700",
    website: "https://noblesmoke.com",
    description:
      "Whole-hog and brisket BBQ from chef Jim Noble — oak and hickory pits, generous sides.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "the-waterman",
    ...
    priceLevel: 2,
    phone: "(704) 351-1916",
    website: "https://www.watermanfishbar.com",
    description:
      "South End raw bar and East-Coast fish shack with poke bowls, oysters, and lobster rolls.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "futo-buta",
    ...
    priceLevel: 2,
    phone: "(704) 936-4044",
    website: "https://futobuta.com",
    description:
      "Cult-favorite South End ramen-ya with tonkotsu broths and Japanese small plates.",
    openingHours: HOURS.dinner_only,
  },
  {
    ...
    description:
      "NoDa New American inside a restored 1920s bungalow — seasonal menus and a leafy patio.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "rooster-noda",
    ...
    priceLevel: 2,
    phone: "(704) 998-1118",
    website: "https://roostersrestaurants.com/noda",
    description:
      "Wood-fired rotisserie and seasonal market plates from the Jim Noble family of restaurants.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "vbgb-beer-hall",
    ...
    priceLevel: 2,
    phone: "(704) 333-4111",
    website: "https://vbgbcharlotte.com",
    description:
      "Sprawling indoor-outdoor beer garden with 50+ taps, giant Jenga, and live music in NoDa.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "sycamore-brewing",
    ...
    priceLevel: 2,
    phone: "(704) 333-0042",
    website: "https://sycamorebrew.com",
    description:
      "Massive South End taproom and beer garden — flagship Mountain Candy IPA, food trucks daily.",
    openingHours: HOURS.brewery,
  },
  {
    id: "resident-culture",
    ...
    description:
      "Plaza Midwood brewery known for hazy IPAs, mixed-culture sours, and a vinyl bar.",
    openingHours: HOURS.brewery,
  },
  {
    ...
    priceLevel: 2,
    phone: "(704) 461-1414",
    website: "https://lincolnshaberdashery.com",
    description:
      "All-day cafe, bakery, and sandwich counter inside historic Atherton Mill in South End.",
  ...
  },
  {
    ...
    priceLevel: 2,
    phone: "(704) 333-5550",
    website: "https://www.iniziopizzeria.com",
    description:
      "VPN-certified Neapolitan pizzeria — 900°F wood ovens, San Marzano sauce, and house mozzarella.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "the-improper-pig",
    ...
    priceLevel: 2,
    phone: "(704) 754-8688",
    website: "https://theimproperpig.com",
    description:
      "Asian-influenced Carolina BBQ — banh-mi sandwiches, smoked wings, and craft sides.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "amelies-bakery",
    ...
    description:
      "Whimsical 24-hour French bakery and cafe famed for its salted-caramel brownies.",
    openingHours: HOURS.bakery_24h,
  },
  {
    ...
    description:
      "Award-winning whole-hog Carolina BBQ with Texas brisket, burnt ends, and 100+ bourbons.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "300-east",
    ...
    priceLevel: 2,
    phone: "(704) 332-6507",
    website: "https://300east.net",
    description:
      "Dilworth bungalow turned New American bistro — long-standing brunch favorite since 1988.",
    openingHours: HOURS.daily_11_10,
  },
  {
    id: "the-stanley",
    ...
    priceLevel: 3,
    phone: "(704) 248-5040",
    website: "https://www.thestanleyclt.com",
    description:
      "Chef Paul Verica's tasting-menu-driven Elizabeth restaurant focused on hyper-seasonal NC produce.",
    openingHours: HOURS.dinner_only,
  },
  {
    id: "sea-level-nc",
    ...
    description:
      "Uptown oyster bar sourcing exclusively from North Carolina waters — raw bar, crudos, whole fish.",
    openingHours: HOURS.dinner_only,
  },
  {
    ...
    lat: 35.2263,
    lng: -80.843,
    address: "100 N Tryon St Ste 100, Charlotte, NC 28202, USA",
    category: "Seafood",
    googleRating: 4.5,
    ...
    description:
      "Polished 1930s ocean-liner-styled seafood room with a daily-changing flown-in fish list.",
    openingHours: HOURS.dinner_only,
  },
  {
    ...
    lat: 35.1909,
    lng: -80.8211,
    address: "4625 Piedmont Row Dr Suite 145A, Charlotte, NC 28210, USA",
    category: "Seafood",
    googleRating: 4.5,
    ...
    description:
      "SouthPark coastal kitchen with raw bar, wood-grilled fish, and a heated patio.",
    openingHours: HOURS.daily_11_10,
  },
  {
    ...
    lat: 35.2266,
    lng: -80.8438,
    address: "200 S Tryon St, Charlotte, NC 28202, USA",
    category: "Seafood",
    googleRating: 4.3,
    ...
    description:
      "Classic Uptown seafood-and-steak house with a popular daily happy hour menu.",
    openingHours: HOURS.daily_11_10,
  },
  {
    ...
    lat: 35.227,
    lng: -80.8425,
    address: "206 N College St, Charlotte, NC 28202, USA",
    category: "Seafood",
    googleRating: 4.5,
    googleTotalRatings: 1300,
    activity: 82,
    ...
    description:
      "Mediterranean-inflected seafood and live jazz in the Hearst Tower — extensive wine cellar.",
    openingHours: HOURS.dinner_only,
  },
  {
    ...
    description:
      "Collaborative LoSo taproom hosting four breweries under one roof, plus food trucks and live music.",
    openingHours: HOURS.brewery,
  },
  ...
  // ===== Must Be Nice + surrounding Plaza Midwood / Optimist Park late-night bars =====
  {
    ...
    lat: 35.2246,
    lng: -80.8168,
    address: "933 Louise Ave Suite 101, Charlotte, NC 28204, USA",
    category: "Cocktail Bar",
    googleRating: 4.6,
    googleTotalRatings: 420,
    activity: 87,
    priceLevel: 3,
    phone: "(704) 461-1516",
    website: "https://mustbeniceclt.com",
    description:
      "Optimist Park cocktail lounge with an aperitivo-forward menu, natural wines, and a rotating DJ program.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "snug-harbor",
    ...
    lat: 35.217,
    lng: -80.8127,
    address: "1228 Gordon St, Charlotte, NC 28204, USA",
    category: "Dive Bar",
    googleRating: 4.5,
    googleTotalRatings: 1350,
    activity: 84,
    priceLevel: 1,
    phone: "(704) 333-9932",
    website: "https://www.snugrock.com",
    description:
      "Beloved Plaza Midwood dive with live indie shows, dance nights, and a graffiti-covered patio.",
    openingHours: HOURS.bar_daily,
  },
  {
    id: "thomas-street-tavern",
    name: "Thomas Street Tavern",
    lat: 35.2181,
    lng: -80.8172,
    address: "1218 Thomas Ave, Charlotte, NC 28205, USA",
    category: "Bar",
    googleRating: 4.5,
    googleTotalRatings: 1600,
    activity: 83,
    priceLevel: 2,
    phone: "(704) 376-1622",
    website: "https://thomasstreettavern.com",
    description:
      "Plaza Midwood neighborhood bar with a huge dog-friendly patio, cheap drafts, and pub grub.",
    openingHours: HOURS.bar_daily,
  },
  {
    id: "common-market-plaza",
    name: "Common Market Plaza Midwood",
    lat: 35.2178,
    lng: -80.8165,
    address: "2007 Commonwealth Ave, Charlotte, NC 28205, USA",
    category: "Bar",
    googleRating: 4.6,
    googleTotalRatings: 1900,
    activity: 82,
    priceLevel: 1,
    phone: "(704) 334-6209",
    website: "https://commonmarketisgood.com",
    description:
      "Deli, bottle shop, and bar hybrid — hundreds of craft beers, sandwiches, and a lively front patio.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "petras-bar",
    ...
    lat: 35.2181,
    lng: -80.8177,
    address: "1919 Commonwealth Ave, Charlotte, NC 28205, USA",
    category: "Cocktail Bar",
    googleRating: 4.6,
    googleTotalRatings: 780,
    activity: 80,
    priceLevel: 2,
    phone: "(704) 332-6608",
    website: "https://www.petrasbar.com",
    description:
      "Cozy Plaza Midwood piano bar and cabaret with drag brunches, karaoke, and craft cocktails.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "legion-brewing-plaza",
    name: "Legion Brewing Plaza Midwood",
    lat: 35.217,
    lng: -80.8195,
    address: "1906 Commonwealth Ave, Charlotte, NC 28205, USA",
    category: "Brewery",
    googleRating: 4.5,
    googleTotalRatings: 1450,
    activity: 81,
    priceLevel: 2,
    phone: "(980) 224-8283",
    website: "https://legionbrewing.com",
    description:
      "Two-story brewpub with a rooftop patio, wood-fired pizzas, and 20+ house beers on tap.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "workmans-friend",
    ...
    lat: 35.2249,
    lng: -80.8172,
    address: "1531 Central Ave, Charlotte, NC 28205, USA",
    category: "Irish Pub",
    googleRating: 4.5,
    googleTotalRatings: 690,
    activity: 78,
    priceLevel: 2,
    phone: "(704) 900-7597",
    website: "https://www.workmansfriendclt.com",
    description:
      "Authentic Irish pub with proper Guinness pours, whiskey flights, and trad-music nights.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "abari-game-bar",
    ...
    lat: 35.228,
    lng: -80.8248,
    address: "1721 N Davidson St, Charlotte, NC 28206, USA",
    category: "Arcade Bar",
    googleRating: 4.6,
    googleTotalRatings: 1100,
    activity: 82,
    priceLevel: 2,
    phone: "(704) 900-7911",
    website: "https://abarigamebar.com",
    description:
      "Retro-arcade bar packed with pinball, classic cabinets, and a rotating craft-beer list in NoDa/Optimist Park.",
    openingHours: HOURS.bar_late,
  },
  ...
  {
    id: "label-charlotte",
    name: "Label Charlotte",
    lat: 35.223,
    lng: -80.8474,
    address: "900 N Carolina Music Factory Blvd, Charlotte, NC 28206, USA",
    category: "Nightclub",
    googleRating: 4.2,
    googleTotalRatings: 2100,
    activity: 94,
    priceLevel: 3,
    phone: "(704) 749-1097",
    website: "https://www.labelclt.com",
    description:
      "Two-story mega club at the AvidXchange Music Factory with international DJs, LED walls, and VIP bottle service.",
    openingHours: HOURS.nightclub,
  },
  {
    id: "whiskey-warehouse",
    name: "Whiskey Warehouse",
    lat: 35.2225,
    lng: -80.847,
    address: "820 Hamilton St, Charlotte, NC 28206, USA",
    category: "Nightclub",
    googleRating: 4.3,
    googleTotalRatings: 1650,
    activity: 91,
    priceLevel: 2,
    phone: "(704) 837-1110",
    website: "https://www.whiskeywarehouseclt.com",
    description:
      "Country-leaning nightclub with mechanical bull, line dancing, and live bands at the Music Factory.",
    openingHours: HOURS.nightclub,
  },
  {
    id: "vbgb-music-factory",
    name: "VBGB Beer Hall & Garden — Music Factory",
    lat: 35.2247,
    lng: -80.8466,
    address: "920 Hamilton St #100, Charlotte, NC 28206, USA",
    category: "Beer Garden",
    ...
    website: "https://vbgbcharlotte.com",
    description:
      "Sprawling indoor-outdoor beer hall with 50+ taps, giant lawn games, and weekend DJs.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "howl-at-the-moon-clt",
    name: "Howl at the Moon Charlotte",
    lat: 35.2245,
    lng: -80.8462,
    address: "820 Hamilton St Suite C11, Charlotte, NC 28206, USA",
    category: "Bar",
    googleRating: 4.4,
    googleTotalRatings: 1400,
    activity: 89,
    priceLevel: 2,
    phone: "(704) 749-1078",
    website: "https://www.howlatthemoon.com/charlotte",
    description:
      "High-energy dueling-pianos bar with sing-along sets, buckets of cocktails, and bachelorette parties.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "selwyn-pub",
    name: "Selwyn Avenue Pub",
    lat: 35.1929,
    lng: -80.8313,
    address: "2801 Selwyn Ave, Charlotte, NC 28209, USA",
    category: "Bar",
    googleRating: 4.5,
    googleTotalRatings: 1850,
    activity: 88,
    priceLevel: 2,
    phone: "(704) 333-3443",
    website: "https://selwynpub.com",
    description:
      "Beloved Myers Park neighborhood pub with oak-shaded patio, 30+ beers on tap, and pub burgers.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "thirsty-beaver",
    ...
    lat: 35.2138,
    lng: -80.8264,
    address: "1225 Central Ave, Charlotte, NC 28204, USA",
    category: "Bar",
    googleRating: 4.7,
    googleTotalRatings: 1300,
    activity: 87,
    priceLevel: 1,
    phone: "(704) 332-3737",
    website: "https://www.thirstybeaversaloon.com",
    description:
      "Iconic Plaza Midwood honky-tonk dive — cheap beer, jukebox country, and the building that refused to sell.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "snug-harbor",
    ...
    priceLevel: 1,
    phone: "(704) 333-9799",
    website: "https://snugrock.com",
    description:
      "Plaza Midwood dive bar and live-music venue with DJ nights, indie shows, and stiff pours.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "the-roxbury",
    ...
    lat: 35.2231,
    lng: -80.8475,
    address: "820 Hamilton St Suite B11, Charlotte, NC 28206, USA",
    category: "Nightclub",
    googleRating: 4.3,
    googleTotalRatings: 1500,
    activity: 88,
    priceLevel: 2,
    phone: "(704) 749-1097",
    website: "https://www.roxburyclt.com",
    description:
      "80s/90s throwback nightclub with themed nights, retro music videos, and costume parties.",
    openingHours: HOURS.nightclub,
  },
  {
    id: "dot-dot-dot",
    ...
    lat: 35.1907,
    lng: -80.8214,
    address: "4237 Park Rd, Charlotte, NC 28209, USA",
    category: "Cocktail Bar",
    googleRating: 4.6,
    googleTotalRatings: 1100,
    activity: 86,
    priceLevel: 3,
    phone: "(980) 209-0070",
    website: "https://www.dotdotdotclt.com",
    description:
      "Members-style speakeasy behind an unmarked door in Park Road — classic cocktails and a vinyl listening room.",
    openingHours: HOURS.bar_late,
  },
  {
    id: "dilworth-tasting-room",
    name: "Dilworth Tasting Room",
    lat: 35.2031,
    lng: -80.8484,
    address: "300 Tremont Ave, Charlotte, NC 28203, USA",
    category: "Wine Bar",
    googleRating: 4.6,
    googleTotalRatings: 950,
    activity: 84,
    priceLevel: 3,
    phone: "(704) 875-1990",
    website: "https://www.dilworthtastingroom.com",
    description:
      "Cozy Dilworth wine bar with 80+ wines by the glass, charcuterie, and a candlelit back patio.",
...
Deno.serve(async (req) => {
  ...
  const curatedFor = (source: string) => {
    const { cityId, venues } = fallbackVenuesForLocation(
      location,
      CHARLOTTE_TOP_VENUES,
    );
    ...
    console.log(
      `Returning ${normalized.length} curated ${cityId} venues (${source})`,
    );
    return new Response(
      JSON.stringify({
        venues: normalized,
    ...
    if (apiKey) {
      try {
        ...
        const ranked = Array.from(seen.values())
          .sort((a, b) => {
            const sa =
              (a.rating ?? 0) * Math.log10((a.user_ratings_total ?? 0) + 10);
            const sb =
              (b.rating ?? 0) * Math.log10((b.user_ratings_total ?? 0) + 10);
            return sb - sa;
          })
          .slice(0, 40);
      ...
      console.warn(
        "GOOGLE_PLACES_API_KEY missing — using curated fallback list",
      );
    }
