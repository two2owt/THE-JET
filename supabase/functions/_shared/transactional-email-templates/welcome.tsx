...
const WelcomeEmail = ({ name }: WelcomeEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>
      Welcome to {SITE_NAME} — your Charlotte nightlife passport
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          drinks, nightlife and events — with exclusive deals from venues we
          love.
        </Text>
        <Section style={{ margin: "8px 0 28px" }}>
          <Text style={listItem}>
            🗺️ Tap the map to see what's hot near you right now
          </Text>
          <Text style={listItem}>
            🔥 Save deals you love — they're claimable in one tap
          </Text>
          <Text style={listItem}>
            👯 Add your crew and meet up where the night's already moving
          </Text>
        </Section>
        ...
        <Text style={footer}>
          Questions? Just reply to this email — a real human will get back to
          you.
        </Text>
      </Container>
    </Body>
