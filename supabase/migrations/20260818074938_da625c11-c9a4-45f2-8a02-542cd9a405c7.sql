CREATE TABLE public.location_permission_events (
...
CREATE INDEX idx_location_permission_events_user_created
  ON public.location_permission_events (user_id, created_at DESC);
CREATE INDEX idx_location_permission_events_outcome
